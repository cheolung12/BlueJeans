...
export default function Main() {
    ...
    return (
        <>
            ...
            {mainData.ebookList && (
                <>
                    <div ref={firstContainerRef} className="w-full h-screen bg-[#F7F7F7] flex flex-col justify-center items-center">
                            ...
                            {ebookList.slice(0, 12).map((book) => (
                                <SwiperSlide key={book.id}>
                                    <Link to={`/ebook/detail/${book.id}`} className="h-full">
                                        <img src={book.thumbnail} alt={book.title} className="w-[180px] h-full object-contain" />
                                    </Link>
                                </SwiperSlide>
                            ))}
                        </Swiper>
                    ...
                    <div className="w-full h-screen bg-[#FFEB60] flex flex-col justify-center items-center">
                        ...
                        <div ref={secondContainerRef2} className="text-xl space-y-4 flex flex-col items-center mb-10">
                        ...
                        <div className="w-full flex justify-center space-x-12 mt-16">
                                ...
                                <Link to={`/essay/detail/${essay0.id}`}>
                                    <img
                                        ...
                                        style={{
                                            ...
                                            WebkitBoxShadow: '10px 10px 5px -4px rgba(207, 207, 207, 0.75)',
                                            MozBoxShadow: '10px 10px 5px -4px rgba(207, 207, 207, 0.75)',
                                        }}
                                    />
                                    <div className="absolute top-0 left-0 p-6 w-full h-full">
                                        <div className="w-full h-full flex flex-col justify-center items-center space-y-2">
                                            <div className="font-bold text-lg">{essay0.nickname} 님</div>
                            ...
                            <div className="w-[250px], h-[250px] relative hover:ease-linear transform hover:scale-105">
                                <Link to={`/essay/detail/${essay1.id}`}>
                                    ...
                                    <div className="absolute top-0 left-0 p-6 w-full h-full">
                                        <div className="w-full h-full flex flex-col justify-center items-center space-y-2">
                                            <div className="font-bold text-lg">{essay1.nickname} 님</div>
                            ...
                            <div className="w-[250px], h-[250px] relative hover:ease-linear transform hover:scale-105">
                                <Link to={`/essay/detail/${essay2.id}`}>
                                    ...
                                    <div className="absolute top-0 left-0 p-6 w-full h-full">
                                        <div className="w-full h-full flex flex-col justify-center items-center space-y-2">
                                            <div className="font-bold text-lg">{essay2.nickname} 님</div>
                    ...
                    <div ref={thirdContainerRef} className="w-full h-screen bg-white lg:flex hidden justify-center items-center px-24">
                        <div className="flex w-full justify-between items-center">
                            ...
                            <div className="w-1/2 h-full justify-start items-center box-border pl-24">
                                <div className="xl:text-5xl 2xl:text-6xl text-4xl font-bold mb-2">소소한 용돈벌이가</div>
                                <div className="xl:text-5xl 2xl:text-6xl text-4xl font-bold mb-8">필요하신가요?</div>
                                <div className="text-lg text-gray-400 mb-2">지역별로 인기공고를 확인하여</div>
                                <div className="text-lg text-gray-400 mb-8">당신의 경력과 노련함을 공유해주세요!</div>
                    ...
                    >
                        <div className="flex w-full justify-center items-center">
                            <div className="w-10/12 justify-start items-center box-border pl-24 mt-28">
                                <div className="sm:text-2xl md:text-4xl text-xl font-bold mb-2">소소한 용돈벌이가</div>
                                <div className="sm:text-2xl md:text-4xl text-xl font-bold mb-8">필요하신가요?</div>
                                <div className="sm:text-xl md:text-3xl text-lg text-black mb-2">지역별로 인기공고를 확인하여</div>
                                <div className="sm:text-xl md:text-3xl text-lg text-black mb-8">당신의 경력과 노련함을 공유해주세요!</div>
                                <Link className="w-full" to="/recruitment">
