...
export default function MyPageForm({ userInfo, setUserInfo }) {
  ...
  return (
    ...
    >
      ...
      <div className='w-56 h-56 rounded-full flex justify-center items-center bg-white border'>
        <img
      ...
      <div className='my-3 w-full h-full flex flex-row justify-center'>
        <label
          htmlFor='nickname'
          className=' m-1 px-1 py-1.5 text-gray-600 font-semibold'
        >
          닉네임 :
        </label>
      ...
      <div className='mb-6 w-full h-full flex flex-row justify-center'>
        <label
          htmlFor='address'
          className=' m-1 px-1 py-1.5 text-gray-600 font-semibold'
        >
      ...
      <div className='flex flex-col justify-center items-center'>
        <div
          className='inline-flex items-center justify-center   text-gray-600  cursor-pointer font-semibold'
      ...
      {editPW && (
        <div className='mt-4'>
          <div className='w-full h-full flex flex-row justify-center mb-2'>
            <label
              htmlFor='password'
              className=' m-1 px-1 py-1.5 text-gray-600 font-semibold'
            >
