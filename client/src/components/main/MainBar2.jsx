...
const MainBar2 = () => {
  return (
    <div className='flex items-end justify-center w-full h-full pl-4 pr-4'>
      <div className='rounded-[30px] shadow-lg items-center justify-around z-30 flex bg-white w-full md:w-3/4 mb-4 md:mb-20 text-sm md:text-lg md:px-6 px-4 md:py-9 py-6'>
        <Link
          to='/recruitment'
